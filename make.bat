...
ml  /Zi /Zd /FR /I%MASMINCPATH% /c  /coff  /Cp stars.asm

if %errorlevel% neq 0 goto :error

ml  /Zi /Zd /FR /I%MASMINCPATH% /c  /coff  /Cp lines.asm

if %errorlevel% neq 0 goto :error

ml  /Zi /Zd /FR /I%MASMINCPATH% /c  /coff  /Cp trig.asm

if %errorlevel% neq 0 goto :error

ml  /Zi /Zd /FR /I%MASMINCPATH% /c  /coff  /Cp blit.asm

if %errorlevel% neq 0 goto :error

ml /Zi /Zd /FR /I%MASMINCPATH% /c  /coff  /Cp game.asm

if %errorlevel% neq 0 goto :error

link /DEBUGTYPE:CV /MAP /SUBSYSTEM:WINDOWS  /LIBPATH:%MASMLIBPATH% game.obj blit.obj trig.obj lines.obj stars.obj libgame.obj
